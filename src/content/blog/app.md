...
pubDate: "2026-09-20"
tags: ["devlog", "mars-dawn"]
draft: false
---
# 一天生出一個 App，順便修了自己埋的三個資安洞

待轉成 `src/content/blog/blog-2026-09-20-marsdawn-one-day-security-holes.md` 時，把下面整段（含 frontmatter）貼進去即可：

```md
---
title: 一天生出一個 App，順便修了自己埋的三個資安洞
slug: marsdawn-one-day-security-holes
pubDate: 2026-09-20
tags:
  - macos
  - swift
...
問題是隔沒幾個小時我就開始抓到自己埋的坑,而且一個比一個有梗。
...
<!-- source: mars-dawn | commits: 57 on 2026-09-17 | generated via cassidy-blog skill -->
